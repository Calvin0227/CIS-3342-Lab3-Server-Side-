...
<body style="height: 342px">
    ...
    <form id="form1" runat="server">
        ...
        <br />
        <br />
        <asp:DropDownList ID="ddlStoreType" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" style="z-index: 1; left: 199px; top: 188px; position: absolute; height: 69px; width: 227px">
        </asp:DropDownList>
        <br />
